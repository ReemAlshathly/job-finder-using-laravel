...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="/show_all_users" class="menu-link">
            <div data-i18n="view user">List</div>
          </a>
        </li>
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div data-i18n="job mangement"></div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
    ...
    <ul class="menu-sub">
      ...
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-dock-top"></i>
        <div data-i18n="messages"></div>
      </a>
      <li class="menu-item">
          <a href="/showall_messeg" class="menu-link">
            <div data-i18n="show jobs">show messeges</div>
          </a>
        </li>
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div data-i18n="show messeges">Authentications</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="javascript:void(0);" class="menu-link menu-toggle">
